...
public class JarTransformer {
	...
	public JarTransformer(final ClassLoader loader, final List<File> sources,
			final List<ClassFileTransformer> classFileTransformers) {
		this(new DefaultLogger(), loader, sources, classFileTransformers);
	}

	public JarTransformer(final Logger logger, final ClassLoader loader, final List<File> sources,
			final List<ClassFileTransformer> classFileTransformers) {
		this.logger = logger;
		this.loader = loader;
